...
'''
This file contains the implementation of the connect four game along side with the minimax AI algorithm 
I develloped during the Data Science path at Codecademy.com
'''
